...
\| \| owner \| String \| 质押金退款地址, 16进制格式， 0x开头 \| \| fee
\| BigInteger \| 出块奖励佣金比，以10000为基数(eg：5%，则fee=500) \| \|
host \| String \| 节点IP \| \| port \| String \| 节点P2P端口号 \| \|
Extra \| String \| 附加数据，json格式字符串类型 \| \| sender \| String
\| 账户地址 \| \| privateKey \| String \| 私钥，需要与账户地址对应 \| \|
gasPrice \| BigUInt \| Energon价格 \| \| gas \| BigUInt \| Energon数量
\| \| value \| BigUInt \| 质押金额 \| \| completion \|
PlatonCommonCompletion \| 回调闭包 \|
